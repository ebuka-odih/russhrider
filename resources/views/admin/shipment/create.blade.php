                ...
                <form action="{{ route('admin.shipment.store') }}" method="POST" >
                    ...
                    <div class="row mb-3">
                       <div class="col-6">
                           ...
                           <input type="text" class="form-control" id="example-if-name" value="{{ old('sender_name') }}" name="sender_name">
                       </div>
                       <div class="col-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="example-if-password" name="courier" >
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
