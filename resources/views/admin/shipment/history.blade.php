        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Add Shipment History</h1>
                </div>
            </div>
        </div>
        <!-- END Hero -->
        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Shipment History</h3>
                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <select name="status" id="" class="form-control">
                                    ...
                                    <option value="Consolidation Complete">Consolidation Complete</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="" for="example-if-phone">Remark</label>
