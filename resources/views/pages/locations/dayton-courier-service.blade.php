...
@section('content')
    ...
    <section id="page-content-title">
        <div id="page-content-header" class="container_24">
            <div id="page-title">
                <h1 class="pagetitle entry-title" itemprop="headline">Dayton Courier Service</h1>
            </div>
            <!-- end page-title -->
        </div>
                ...
                <div class="main-content-padding">
                    <div itemprop="mainContentOfPage"  itemscope="itemscope">
                        <article class="post-48 page type-page status-publish hentry" id="post-48">
                            ...
                            <div class="entry">
                                <p class="post"><strong><em>Providing Same Day Courier Service and Freight Services with terminals based in Dayton, Cincinnati and Columbus, Ohio</em></strong></p>
                                <p class="post">The Dayton Service Center is located at 2619 Needmore Road, Dayton, Ohio 45414.</p>
                                <p>Applications for employment can be obtained: </p>
                                <p>Monday &#8211; Friday 6am to 6pm or call Rush Transportation and Logistics (937) 297-6182.</p>
                                <i class="fa fa-truck" style="color:#019b3c;"></i> Serving the Midwest Region Since 1981<br />
                                <i class="fa fa-truck" style="color:#019b3c;"></i> Rush Headquarters<br />
                                <i class="fa fa-truck" style="color:#019b3c;"></i> Easy Access to I-70 and I-75 <br />
                                <i class="fa fa-truck" style="color:#019b3c;"></i> 5+ acre property<br />
                                <i class="fa fa-truck" style="color:#019b3c;"></i> 10,000+ sq. ft. warehouse<br />
                                <i class="fa fa-truck" style="color:#019b3c;"></i> 6 dock terminal</p>
                                <p><iframe style="border: 0;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3064.3568604519055!2d-84.18509568440835!3d39.82141597943875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8840821c35aa1d75%3A0xfde98bd93b1e2987!2s2619+Needmore+Rd%2C+Dayton%2C+OH+45414!5e0!3m2!1sen!2sus!4v1511037022873" width="600" height="450" frameborder="0" allowfullscreen="allowfullscreen"></iframe></p>
                            </div>
                ...
                <div id="sidebarSubnav">
                    <div itemtype="https://schema.org/WPSideBar" itemscope="itemscope">
                        <div id="text-2" class="widget widget_text substitute_widget_class">
                            <h3 class="widgettitle">Need it today?</h3>			<div class="textwidget"><div class="box">
