...
<footer>
                ...
                <div class="col-md-3 xxs_fullwidth col-xs-6">
                    <div class="footer_widgets contact reveal animated" data-anim="fadeInRightShort" data-delay="0.4s">
                        ...
                        <div class="footer_address">
                            <ul>
                                <li><span class="fa fa-paper-plane-o"></span> <div class="address_right">50 Main Design Street,US</div></li>
                                <li>
    ...
    <footer>
        <script src="http://code.tidio.co/bm9r4oeww0yqkkwu65vxqxgjs7uqy6s6.js" async></script>
    </footer>
